function C(s){console.log(s())}function v(s){console.warn(s())}function w(s){throw new Error(s())}function g(s,t){if(!s)throw new Error(t?t():"Assertion failed.")}var ws=async function(){}.constructor;function ut(s,t){if(s===t)return!0;if(s===null||t===null||s===void 0||t===void 0||typeof s!=typeof t||typeof s!="object")return!1;if(Array.isArray(s)){if(!Array.isArray(t)||s.length!==t.length)return!1;for(let i=0;i<s.length;i++)if(!ut(s[i],t[i]))return!1}else{let i=Object.keys(s);if(i.length!==Object.keys(t).length)return!1;for(let e of i)if(!ut(s[e],t[e]))return!1}return!0}function j(s){if(typeof s!="object"||s===null)return s;let t,i,e=Object.prototype.toString.call(s);if(e==="[object Object]"){if(s.constructor!==Object&&typeof s.constructor=="function"){i=new s.constructor;for(t in s)s.hasOwnProperty(t)&&i[t]!==s[t]&&(i[t]=j(s[t]))}else{i={};for(t in s)t==="__proto__"?Object.defineProperty(i,t,{value:j(s[t]),configurable:!0,enumerable:!0,writable:!0}):i[t]=j(s[t])}return i}if(e==="[object Array]"){for(t=s.length,i=Array(t);t--;)i[t]=j(s[t]);return i}return e==="[object Set]"?(i=new Set,s.forEach(function(n){i.add(j(n))}),i):e==="[object Map]"?(i=new Map,s.forEach(function(n,h){i.set(j(h),j(n))}),i):e==="[object Date]"?new Date(+s):e==="[object RegExp]"?(i=new RegExp(s.source,s.flags),i.lastIndex=s.lastIndex,i):e==="[object DataView]"?new s.constructor(j(s.buffer)):e==="[object ArrayBuffer]"?s.slice(0):e.slice(-6)==="Array]"?new s.constructor(s):s}function et(s){throw new Error(`Unexpected object: ${s}`)}var H=1e-7;function ms(s){return s*Math.PI/180}function Ns(s){return s*180/Math.PI}function W(s,t,i){return Math.min(Math.max(s,t),i)}function*zs(s,t,i=1){s=Math.round(s),t===void 0?(t=s,s=0):t=Math.round(t),i=Math.max(1,Math.round(Math.abs(i)));let e=Math.sign(t-s)||1;for(;Math.sign(t-s)!==-e;)yield s,s+=i*e}function ps(s){return s.toString(16).padStart(2,"0")}function Ss(s){return Number.isInteger(s)&&(s&s-1)===0}function Is(s){return s===0?1:Math.floor(Math.log10(Math.abs(s)))+1}function Us(s){return Math.ceil(s/2)*2}function Os(s,t,i,e=0,n=1){return e+(s-t)/(i-t)*(n-e)}var It;(function(s){s[s.VERTEX=35633]="VERTEX",s[s.FRAGMENT=35632]="FRAGMENT"})(It||(It={}));var tt;(function(s){s[s.TEXTURE=1]="TEXTURE",s[s.RENDERBUFFER=2]="RENDERBUFFER"})(tt||(tt={}));var p;(function(s){s[s.BYTE=5120]="BYTE",s[s.UNSIGNED_BYTE=5121]="UNSIGNED_BYTE",s[s.SHORT=5122]="SHORT",s[s.UNSIGNED_SHORT=5123]="UNSIGNED_SHORT",s[s.INT=5124]="INT",s[s.UNSIGNED_INT=5125]="UNSIGNED_INT",s[s.FLOAT=5126]="FLOAT",s[s.HALF_FLOAT=5131]="HALF_FLOAT",s[s.INT_2_10_10_10_REV=36255]="INT_2_10_10_10_REV",s[s.UNSIGNED_INT_2_10_10_10_REV=33640]="UNSIGNED_INT_2_10_10_10_REV"})(p||(p={}));var Q;(function(s){s[s.UNSIGNED_BYTE=5121]="UNSIGNED_BYTE",s[s.UNSIGNED_SHORT=5123]="UNSIGNED_SHORT",s[s.UNSIGNED_INT=5125]="UNSIGNED_INT"})(Q||(Q={}));var at;(function(s){s[s.STATIC_DRAW=35044]="STATIC_DRAW",s[s.STREAM_DRAW=35040]="STREAM_DRAW",s[s.DYNAMIC_DRAW=35048]="DYNAMIC_DRAW",s[s.STATIC_READ=35045]="STATIC_READ",s[s.DYNAMIC_READ=35049]="DYNAMIC_READ",s[s.STREAM_READ=35041]="STREAM_READ",s[s.STATIC_COPY=35046]="STATIC_COPY",s[s.DYNAMIC_COPY=35050]="DYNAMIC_COPY",s[s.STREAM_COPY=35042]="STREAM_COPY"})(at||(at={}));var P;(function(s){s[s.TEXTURE_2D=3553]="TEXTURE_2D",s[s.TEXTURE_3D=32879]="TEXTURE_3D",s[s.TEXTURE_CUBE_MAP=34067]="TEXTURE_CUBE_MAP",s[s.TEXTURE_2D_ARRAY=35866]="TEXTURE_2D_ARRAY"})(P||(P={}));var J;(function(s){s[s.TEXTURE_2D=3553]="TEXTURE_2D",s[s.TEXTURE_CUBE_MAP_POSITIVE_X=34069]="TEXTURE_CUBE_MAP_POSITIVE_X",s[s.TEXTURE_CUBE_MAP_NEGATIVE_X=34070]="TEXTURE_CUBE_MAP_NEGATIVE_X",s[s.TEXTURE_CUBE_MAP_POSITIVE_Y=34071]="TEXTURE_CUBE_MAP_POSITIVE_Y",s[s.TEXTURE_CUBE_MAP_NEGATIVE_Y=34072]="TEXTURE_CUBE_MAP_NEGATIVE_Y",s[s.TEXTURE_CUBE_MAP_POSITIVE_Z=34073]="TEXTURE_CUBE_MAP_POSITIVE_Z",s[s.TEXTURE_CUBE_MAP_NEGATIVE_Z=34074]="TEXTURE_CUBE_MAP_NEGATIVE_Z",s[s.TEXTURE_3D=32879]="TEXTURE_3D",s[s.TEXTURE_2D_ARRAY=35866]="TEXTURE_2D_ARRAY"})(J||(J={}));var N;(function(s){s[s.UNSIGNED_BYTE=5121]="UNSIGNED_BYTE",s[s.UNSIGNED_SHORT=5123]="UNSIGNED_SHORT",s[s.UNSIGNED_SHORT_5_6_5=33635]="UNSIGNED_SHORT_5_6_5",s[s.UNSIGNED_SHORT_5_5_5_1=32820]="UNSIGNED_SHORT_5_5_5_1",s[s.UNSIGNED_SHORT_4_4_4_4=32819]="UNSIGNED_SHORT_4_4_4_4",s[s.UNSIGNED_INT=5125]="UNSIGNED_INT",s[s.UNSIGNED_INT_5_9_9_9_REV=35902]="UNSIGNED_INT_5_9_9_9_REV",s[s.UNSIGNED_INT_2_10_10_10_REV=33640]="UNSIGNED_INT_2_10_10_10_REV",s[s.UNSIGNED_INT_10F_11F_11F_REV=35899]="UNSIGNED_INT_10F_11F_11F_REV",s[s.UNSIGNED_INT_24_8=34042]="UNSIGNED_INT_24_8",s[s.HALF_FLOAT=5131]="HALF_FLOAT",s[s.FLOAT=5126]="FLOAT"})(N||(N={}));var m;(function(s){s[s.R8=33321]="R8",s[s.R16F=33325]="R16F",s[s.R32F=33326]="R32F",s[s.R8UI=33330]="R8UI",s[s.RG8=33323]="RG8",s[s.RG16F=33327]="RG16F",s[s.RG32F=33328]="RG32F",s[s.RG8UI=33336]="RG8UI",s[s.RGB8=32849]="RGB8",s[s.SRGB8=35905]="SRGB8",s[s.RGB565=36194]="RGB565",s[s.R11F_G11F_B10F=35898]="R11F_G11F_B10F",s[s.RGB9_E5=35901]="RGB9_E5",s[s.RGB16F=34843]="RGB16F",s[s.RGB32F=34837]="RGB32F",s[s.RGB8UI=36221]="RGB8UI",s[s.RGBA8=32856]="RGBA8",s[s.SRGB8_ALPHA8=35907]="SRGB8_ALPHA8",s[s.RGB5_A1=32855]="RGB5_A1",s[s.RGBA4=32854]="RGBA4",s[s.RGB10_A2=32857]="RGB10_A2",s[s.RGBA16F=34842]="RGBA16F",s[s.RGBA32F=34836]="RGBA32F",s[s.RGBA8UI=36220]="RGBA8UI",s[s.DEPTH_COMPONENT16=33189]="DEPTH_COMPONENT16",s[s.DEPTH_COMPONENT24=33190]="DEPTH_COMPONENT24",s[s.DEPTH_COMPONENT32F=36012]="DEPTH_COMPONENT32F",s[s.DEPTH24_STENCIL8=35056]="DEPTH24_STENCIL8",s[s.DEPTH32F_STENCIL8=36013]="DEPTH32F_STENCIL8",s[s.STENCIL_INDEX8=36168]="STENCIL_INDEX8"})(m||(m={}));var L;(function(s){s[s.NEAREST=9728]="NEAREST",s[s.LINEAR=9729]="LINEAR",s[s.NEAREST_MIPMAP_NEAREST=9984]="NEAREST_MIPMAP_NEAREST",s[s.LINEAR_MIPMAP_NEAREST=9985]="LINEAR_MIPMAP_NEAREST",s[s.NEAREST_MIPMAP_LINEAR=9986]="NEAREST_MIPMAP_LINEAR",s[s.LINEAR_MIPMAP_LINEAR=9987]="LINEAR_MIPMAP_LINEAR"})(L||(L={}));var st;(function(s){s[s.REPEAT=10497]="REPEAT",s[s.CLAMP_TO_EDGE=33071]="CLAMP_TO_EDGE",s[s.MIRRORED_REPEAT=33648]="MIRRORED_REPEAT"})(st||(st={}));var nt;(function(s){s[s.NONE=0]="NONE",s[s.NEVER=512]="NEVER",s[s.LESS=513]="LESS",s[s.EQUAL=514]="EQUAL",s[s.LEQUAL=515]="LEQUAL",s[s.GREATER=516]="GREATER",s[s.NOTEQUAL=517]="NOTEQUAL",s[s.GEQUAL=518]="GEQUAL",s[s.ALWAYS=519]="ALWAYS"})(nt||(nt={}));var Ut;(function(s){s[s.RGBA4=32854]="RGBA4",s[s.RGB565=36194]="RGB565",s[s.RGB5_A1=32855]="RGB5_A1",s[s.DEPTH_COMPONENT16=33189]="DEPTH_COMPONENT16",s[s.STENCIL_INDEX8=36168]="STENCIL_INDEX8",s[s.DEPTH_STENCIL=34041]="DEPTH_STENCIL",s[s.R8=33321]="R8",s[s.R8UI=33330]="R8UI",s[s.R8I=33329]="R8I",s[s.R16UI=33332]="R16UI",s[s.R16I=33331]="R16I",s[s.R32UI=33334]="R32UI",s[s.R32I=33333]="R32I",s[s.RG8=33323]="RG8",s[s.RG8UI=33336]="RG8UI",s[s.RG8I=33335]="RG8I",s[s.RG16UI=33338]="RG16UI",s[s.RG16I=33337]="RG16I",s[s.RG32UI=33340]="RG32UI",s[s.RG32I=33339]="RG32I",s[s.RGB8=32849]="RGB8",s[s.RGBA8=32856]="RGBA8",s[s.SRGB8_ALPHA8=35907]="SRGB8_ALPHA8",s[s.RGB10_A2=32857]="RGB10_A2",s[s.RGBA8UI=36220]="RGBA8UI",s[s.RGBA8I=36238]="RGBA8I",s[s.RGB10_A2UI=36975]="RGB10_A2UI",s[s.RGBA16UI=36214]="RGBA16UI",s[s.RGBA16I=36232]="RGBA16I",s[s.RGBA32I=36226]="RGBA32I",s[s.RGBA32UI=36208]="RGBA32UI",s[s.DEPTH_COMPONENT24=33190]="DEPTH_COMPONENT24",s[s.DEPTH_COMPONENT32F=36012]="DEPTH_COMPONENT32F",s[s.DEPTH24_STENCIL8=35056]="DEPTH24_STENCIL8",s[s.DEPTH32F_STENCIL8=36013]="DEPTH32F_STENCIL8",s[s.R16F=33325]="R16F",s[s.RG16F=33327]="RG16F",s[s.RGBA16F=34842]="RGBA16F",s[s.R32F=33326]="R32F",s[s.RG32F=33328]="RG32F",s[s.RGBA32F=34836]="RGBA32F",s[s.R11F_G11F_B10F=35898]="R11F_G11F_B10F"})(Ut||(Ut={}));var ft;(function(s){s[s.NONE=0]="NONE",s[s.FRONT=1028]="FRONT",s[s.BACK=1029]="BACK",s[s.FRONT_AND_BACK=1032]="FRONT_AND_BACK"})(ft||(ft={}));var lt;(function(s){s[s.NONE=0]="NONE",s[s.NEVER=512]="NEVER",s[s.LESS=513]="LESS",s[s.EQUAL=514]="EQUAL",s[s.LEQUAL=515]="LEQUAL",s[s.GREATER=516]="GREATER",s[s.NOTEQUAL=517]="NOTEQUAL",s[s.GEQUAL=518]="GEQUAL",s[s.ALWAYS=519]="ALWAYS"})(lt||(lt={}));var rt;(function(s){s[s.ZERO=0]="ZERO",s[s.ONE=1]="ONE",s[s.SRC_COLOR=768]="SRC_COLOR",s[s.ONE_MINUS_SRC_COLOR=769]="ONE_MINUS_SRC_COLOR",s[s.DST_COLOR=774]="DST_COLOR",s[s.ONE_MINUS_DST_COLOR=775]="ONE_MINUS_DST_COLOR",s[s.SRC_ALPHA=770]="SRC_ALPHA",s[s.ONE_MINUS_SRC_ALPHA=771]="ONE_MINUS_SRC_ALPHA",s[s.DST_ALPHA=772]="DST_ALPHA",s[s.ONE_MINUS_DST_ALPHA=773]="ONE_MINUS_DST_ALPHA",s[s.CONSTANT_COLOR=32769]="CONSTANT_COLOR",s[s.ONE_MINUS_CONSTANT_COLOR=32770]="ONE_MINUS_CONSTANT_COLOR",s[s.CONSTANT_ALPHA=32771]="CONSTANT_ALPHA",s[s.ONE_MINUS_CONSTANT_ALPHA=32772]="ONE_MINUS_CONSTANT_ALPHA",s[s.SRC_ALPHA_SATURATE=776]="SRC_ALPHA_SATURATE"})(rt||(rt={}));var q;(function(s){s[s.POINTS=0]="POINTS",s[s.LINES=1]="LINES",s[s.LINE_LOOP=2]="LINE_LOOP",s[s.LINE_STRIP=3]="LINE_STRIP",s[s.TRIANGLES=4]="TRIANGLES",s[s.TRIANGLE_STRIP=5]="TRIANGLE_STRIP"})(q||(q={}));function vs(s,t={}){let i=null;typeof s=="string"?(i=document.querySelector(`#${s}`),i==null&&w(()=>`Could not find canvas element with id "${s}"`)):s instanceof HTMLCanvasElement?i=s:w(()=>`Invalid canvas element "${s}"`);let e=i.id??"unnamed canvas",n=i.getContext("webgl2",{alpha:t.alpha??!0,depth:t.depth??!0,stencil:t.stencil??!1,antialias:t.antialias??!1,premultipliedAlpha:t.premultipliedAlpha??!1,preserveDrawingBuffer:t.preserveDrawingBuffer??!0,powerPreference:t.powerPreference??"high-performance",desynchronized:t.desynchronized??!0});return n===null&&w(()=>`Could not acquire a WebGL2 context from canvas "${e}"`),n.getExtension("EXT_color_buffer_float")===null&&v(()=>"Extension 'EXT_color_buffer_float' is not supported."),n.getExtension("EXT_texture_filter_anisotropic")===null&&v(()=>"Extension 'EXT_texture_filter_anisotropic' is not supported."),n.__glance={generation:1,shaders:new Map,programs:new Map,buffers:new Array,vaos:new Array,textures:new Array,renderbuffers:new Array,framebuffers:new Array},n}function Ot(s,t,i,e){i!==s.VERTEX_SHADER&&i!==s.FRAGMENT_SHADER&&w(()=>`Invalid shader stage ${i} for shader "${t}"`);let n=i===s.VERTEX_SHADER?"vertex":"fragment";{let r=s.__glance.shaders.get(e);if(r){let c=r.object;return c.stage!==i&&w(()=>`Shader "${t}" already exists as a ${c.stage===s.VERTEX_SHADER?"vertex":"fragment"} shader.`),r.generation=s.__glance.generation,C(()=>`Reusing cached ${n} shader "${t}"`),c}}let h=s.createShader(i);if(h||w(()=>`Failed to create ${n} shader "${t}"`),s.shaderSource(h,e),s.compileShader(h),!s.getShaderParameter(h,s.COMPILE_STATUS)){let r=s.getShaderInfoLog(h);s.deleteShader(h),w(()=>`Failed to compile ${n} shader "${t}": ${r}`)}let a={glo:h,name:t,stage:i,source:e};return C(()=>`Created ${n} shader "${t}"`),s.__glance.shaders.set(e,{object:a,generation:s.__glance.generation}),a}function Bs(s,t,i,e,n){typeof i=="string"?i=Ot(s,`${t}-vertex`,s.VERTEX_SHADER,i):(!s.isShader(i.glo)||i.stage!==s.VERTEX_SHADER)&&w(()=>`Invalid vertex shader for program "${t}"`),typeof e=="string"?e=Ot(s,`${t}-fragment`,s.FRAGMENT_SHADER,e):(!s.isShader(e.glo)||e.stage!==s.FRAGMENT_SHADER)&&w(()=>`Invalid fragment shader for program "${t}"`);let h=`${i.source}
...
`);for(let[c,o]of r.entries()){let f=o.split(" "),d=f[0];if(!t.has(d))if(d==="o")i===void 0?i=f[1]:w(()=>`Multiple object names defined in OBJ file (on line ${c})`);else if(d==="v")e.push(parseFloat(f[1]),parseFloat(f[2]),parseFloat(f[3]));else if(d==="vn")h.push(parseFloat(f[1]),parseFloat(f[2]),parseFloat(f[3]));else if(d==="vt")a.push(parseFloat(f[1]),parseFloat(f[2]));else if(d==="f")for(let l=1;l<=3;l++){let u=f[l].split("/"),x=parseInt(u[0])-1,E=u.length>1&&u[1]!==""?parseInt(u[1])-1:x,y=u.length>2?parseInt(u[2])-1:x;n.push([x,E,y])}else v(()=>`Unexpected OBJ token: "${d}" on line ${c}`)}return i===void 0&&w(()=>`No object name defined in OBJ file: "${s}"`),h.length===0&&(console.log(`Calculating normals for object "${i}"`),h.push(...bs(e,n.map(c=>c[2])))),a.length===0&&(v(()=>`No texture coordinates defined for object "${i}"`),a.push(...new Array(e.length/3*2).fill(0))),{name:i,positions:e,texCoords:a,normals:h,splitIndices:n}}function Ms(s,t){let i=t.positions,e=t.texCoords,n=t.normals,h=t.indices,a=0,r=new Map;for(let c of s.splitIndices){let o=c.join("|"),f=r.get(o);if(f!==void 0){h.push(f);continue}let[d,l,u]=c,x=d*3;i.push(...s.positions.slice(x,x+3));let E=l*2;e.push(...s.texCoords.slice(E,E+2));let y=u*3;n.push(...s.normals.slice(y,y+3)),h.push(a),r.set(o,a),a++}t.tangents=zt(i,e,h,n)}async function ki(s){let i=await(await fetch(s,{mode:"cors",method:"GET",headers:{"Content-Type":"text/plain"}})).text(),e=As(i),n={name:e.name,positions:[],indices:[],texCoords:[],normals:[],tangents:[]};return Ms(e,n),n.name,n.indices,n.positions,Xt(n.name,n.indices,n.positions,n.texCoords,n.normals,n.tangents),n}function Vi(s){let t=new Set,i=s.indices.length,e=s.positions.length/3,n=e;for(let h=0;h<i;h++){let a=s.indices[h];t.has(a)?(s.indices[h]=n,t.add(n++),s.positions.push(s.positions[a*3],s.positions[a*3+1],s.positions[a*3+2]),s.texCoords.push(s.texCoords[a*2],s.texCoords[a*2+1]),s.normals.push(s.normals[a*3],s.normals[a*3+1],s.normals[a*3+2]),s.tangents.push(s.tangents[a*3],s.tangents[a*3+1],s.tangents[a*3+2])):t.add(a)}e!==n&&C(()=>`Uniquified ${n-e} vertices.`)}function Yi(s){new Set(s.indices).size!==s.indices.length&&w(()=>`The geometry "${s.name}" must have unique vertices to generate barycentric coordinates.`);let t=new Array(s.positions.length).fill(0),i=s.indices;for(let e=0;e<s.indices.length;e+=3)t[i[e]*3]=1,t[i[e+1]*3+1]=1,t[i[e+2]*3+2]=1;return g(t.length===s.positions.length,()=>`Failed to calculate barycentric coordinates for geometry "${s.name}"`),t}function Xt(s,t,i,e,n,h){i.length%3!==0&&w(()=>`The positions array of "${s}" must have a length that is a multiple of 3, but it is ${i.length}.`),t.length%3!==0&&w(()=>`The indices array of "${s}" must have a length that is a multiple of 3, but it is ${t.length}.`),e&&e.length%2!==0&&w(()=>`The UVs array of "${s}" must have a length that is a multiple of 2, but it is ${e.length}.`),n&&n.length%3!==0&&w(()=>`The normals array of "${s}" must have a length that is a multiple of 3, but it is ${n.length}.`),h&&h.length%3!==0&&w(()=>`The tangents array of "${s}" must have a length that is a multiple of 3, but it is ${h.length}.`);let a=i.length/3;e&&e.length/2!==a&&w(()=>`The UVs array of "${s}" must have the same number of elements as the positions array.`),n&&n.length!==i.length&&w(()=>`The normals array of "${s}" must have the same number of elements as the positions array.`),h&&h.length!==i.length&&w(()=>`The tangents array of "${s}" must have the same number of elements as the positions array.`);let r=new Set;for(let f of t)r.add(f);if(r.size===a)return;let c=new Array;for(let f=0;f<a;f++)r.has(f)||c.push(f);for(let f=c.length-1;f>=0;f--){let d=c[f];i.splice(d*3,3),e&&e.splice(d*2,2),n&&n.splice(d*3,3),h&&h.splice(d*3,3)}let o=[];{let f=0,d=c[0],l=1;for(let u=0;u<a;u++)u===d&&(f++,d=c[l++]),o.push(f)}for(let f=0;f<t.length;f++)t[f]-=o[t[f]];C(()=>`Removed ${c.length} unused vertices from "${s}".`)}function bs(s,t){if(s.length===0||t.length===0)return v(()=>"Skipping computation of normals for an empty mesh."),[];t.length%3!==0&&w(()=>"The indices array must be a multiple of 3."),s.length%3!==0&&w(()=>"The positions array must be a multiple of 3.");let i=new Array(s.length).fill(0);for(let e=0;e<t.length;e+=3){let n=t[e]*3,h=t[e+1]*3,a=t[e+2]*3,r=s[n],c=s[n+1],o=s[n+2],f=s[h]-r,d=s[h+1]-c,l=s[h+2]-o,u=s[a]-r,x=s[a+1]-c,E=s[a+2]-o,y=d*E-l*x,A=l*u-f*E,M=f*x-d*u;i[n]+=y,i[n+1]+=A,i[n+2]+=M,i[h]+=y,i[h+1]+=A,i[h+2]+=M,i[a]+=y,i[a+1]+=A,i[a+2]+=M}for(let e=0;e<i.length;e+=3){let n=Math.hypot(i[e],i[e+1],i[e+2]);if(n===0){v(()=>`Cannot generate normal for vertex ${e/3} because it is not part of a face.`);continue}i[e]/=n,i[e+1]/=n,i[e+2]/=n}return i}function zt(s,t,i,e){if(s.length===0||t.length===0||i.length===0)return v(()=>"Skipping computation of tangents for an empty mesh."),[];i.length%3!==0&&w(()=>"The indices array must be a multiple of 3."),s.length%3!==0&&w(()=>"The positions array must be a multiple of 3."),t.length%2!==0&&w(()=>"The UVs array must be a multiple of 2."),e&&e.length%3!==0&&w(()=>"The normals array must be a multiple of 3.");let n=s.length/3;t.length/2!==n&&w(()=>"The UVs array must have the same number of elements as the positions array."),e&&e.length!==s.length&&w(()=>"The normals array must have the same number of elements as the positions array.");let h=Array(s.length).fill(0);for(let a=0;a<i.length;a+=3){let r=i[a],c=i[a+1],o=i[a+2],f=s[r*3],d=s[r*3+1],l=s[r*3+2],u=s[c*3]-f,x=s[c*3+1]-d,E=s[c*3+2]-l,y=s[o*3]-f,A=s[o*3+1]-d,M=s[o*3+2]-l,_=t[r*2],b=t[r*2+1],R=t[c*2]-_,T=t[c*2+1]-b,U=t[o*2]-_,O=t[o*2+1]-b,z=1/(R*O-U*T),G=(O*u-T*y)*z,$=(O*x-T*A)*z,D=(O*E-T*M)*z;h[r*3]+=G,h[r*3+1]+=$,h[r*3+2]+=D,h[c*3]+=G,h[c*3+1]+=$,h[c*3+2]+=D,h[o*3]+=G,h[o*3+1]+=$,h[o*3+2]+=D}if(e)for(let a=0;a<h.length;a+=3){let r=h[a],c=h[a+1],o=h[a+2],f=e[a],d=e[a+1],l=e[a+2],u=f*r+d*c+l*o;r-=u*f,c-=u*d,o-=u*l;let x=Math.hypot(r,c,o);x!==0&&(h[a]=r/x,h[a+1]=c/x,h[a+2]=o/x)}else for(let a=0;a<h.length;a+=3){let r=Math.hypot(h[a],h[a+1],h[a+2]);r!==0&&(h[a]/=r,h[a+1]/=r,h[a+2]/=r)}return h}function Ki(s){if(s.ctx===void 0&&(s.width===void 0||s.height===void 0))throw new Error("Either ctx or width and height must be provided.");let t=s.width??s.ctx.canvas.width,i=s.height??s.ctx.canvas.height;return ct(s.gl,s.name,t,i,{useAnisotropy:!0,internalFormat:m.RGBA8})}function Zi(s,t={}){let i=t.gridSize??10,e=t.axisWidth??2,n=t.gridWidth??1,h=t.axisColorX??"rgb(255, 255, 255)",a=t.axisColorY??"rgb(255, 255, 255)",r=t.gridColor??"rgb(255, 255, 255)",c=t.axisAlpha??1,o=t.gridAlpha??.9;if(i%2!=0)throw new Error(`Grid Size must be an even number, got ${i}`);let f=s.canvas.width,d=s.canvas.height,l=Math.max(e,n),u=(f-l*2)/i;s.lineWidth=n,s.lineCap="round",s.globalAlpha=1,s.strokeStyle=r;for(let E=0;E<=i;E++){let y=l+E*u;s.beginPath(),s.moveTo(y,l),s.lineTo(y,d-l),s.stroke(),s.beginPath(),s.moveTo(l,y),s.lineTo(f-l,y),s.stroke()}if(o<1){var x=s.getImageData(0,0,s.canvas.width,s.canvas.height);let E=x.data;for(let y=0;y<E.length;y+=4)E[y+3]*=o;s.putImageData(x,0,0)}s.lineWidth=e,s.globalAlpha=c,s.strokeStyle=h,s.beginPath(),s.moveTo(l,d/2),s.lineTo(f-l,d/2),s.stroke(),s.strokeStyle=a,s.beginPath(),s.moveTo(f/2,l),s.lineTo(f/2,d-l),s.stroke(),s.globalAlpha=1}function Qi(s,t,i){try{s.bindTexture(s.TEXTURE_2D,i.glo),s.texSubImage2D(s.TEXTURE_2D,0,0,0,s.RGBA,s.UNSIGNED_BYTE,t.canvas),s.generateMipmap(s.TEXTURE_2D)}finally{s.bindTexture(s.TEXTURE_2D,null)}}function Rs(s,t){return Array.from({length:t},()=>s).flat()}function se(s,t,i){return s.slice(t,t+i)}function ie(s,t=1){if(s.length===0)return[];if(s.length===1)return s[0];Array.isArray(t)?t.length!==s.length&&w(()=>`'quantities' must be either a number or an array with the same length as 'arrays'.
    ...
    whereas the first array conttains ${s[0].length/h} times ${t[0]} quantities.`)}let e=[];for(let n=0;n<i;n++)for(let h=0;h<s.length;h++){let a=s[h],r=t[h];e.push(...a.slice(n*r,(n+1)*r))}return e}async function ee(s){try{return await(await fetch(s)).text()}catch(t){throw new Error(`Failed to load code snippet from ${s}: ${t}`)}}export{tt as AttachmentType,p as AttributeDataType,rt as BlendFunc,at as BufferUsage,ft as CullFace,lt as DepthTest,q as DrawMode,H as EPSILON,Bt as FramebufferStack,Q as IndexDataType,Y as Mat3,it as Mat4,ht as Quat,Nt as Rect,Ut as RenderbufferInternalFormat,It as ShaderStage,nt as TextureCompareFunc,J as TextureDataTarget,L as TextureFilter,m as TextureInternalFormat,N as TextureSrcDataType,P as TextureTarget,st as TextureWrap,k as Vec2,B as Vec3,X as Vec4,W as clamp,Qi as copyCanvasToTexture,Is as countDigits,Ls as createAttributeBuffer,Fi as createBox,Ki as createCanvasTexture,Li as createCircularPlane,Vs as createDrawCall,Hs as createFramebuffer,Fs as createIndexBuffer,Bi as createPlane,Bs as createProgram,Xs as createRenderbuffer,Xi as createScreenQuat,Ot as createShader,Ci as createSphere,ct as createTexture,Hi as createTorusKnot,Cs as createVertexArrayObject,Ns as degrees,Ys as draw,Zi as draw2DGrid,Yi as getBaricentricCoordinates,vs as getContext,ps as hex,ie as interleaveArrays,Ss as isPowerOf2,ee as loadCodeSnippet,ti as loadCubemap,ki as loadObj,Js as loadTexture,Os as mapRange,_i as mulberry32,Us as nextEven,Ai as openSimplex2SHeightmap,ms as radians,zs as range,Rs as repeat,js as resetContext,se as slice,Vi as uniquifyVertices,ks as updateFramebufferLayer,Tt as updateTextureData};
/// @license MIT
